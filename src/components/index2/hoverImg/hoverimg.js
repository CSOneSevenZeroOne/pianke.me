    ...
    render(){
        return (
            ...
            <div id="hoverImg" className="main">
                <div id="img1">
                    <a>
                        <img  className="img2" src={this.state.arrImg[0]} alt="" width="100%"/>
                        <span id="sp1">
                        </span>
                        <span id="sp2">{this.state.arrWords[0]}</span>
                    </a>
                </div>
                 ...
                 <ul id="oul">
                     <li className="allimg">
                             <a>
                                 <img  className="img2" src={this.state.arrImg[1]} alt="" width="100%"/>
                                 <span id="sp1">
                                 </span>
                                 <span id="sp2">{this.state.arrWords[1]}</span>
                             </a>
                     </li>
                     <li className="allimg">
                         <a>
                             <img  className="img2" src={this.state.arrImg[2]} alt="" width="100%"/>
                             <span id="sp1">
                                 </span>
                             <span id="sp2">{this.state.arrWords[2]}</span>
                         </a>
                     </li>
                     <li className="allimg">
                         <a>
                             <img  className="img2" src={this.state.arrImg[3]} alt="" width="100%"/>
                             <span id="sp1">
                                 </span>
                             <span id="sp2">{this.state.arrWords[3]}</span>
                         </a>
                     </li>
                     <li className="allimg">
                         <a>
                             <img  className="img2" src={this.state.arrImg[4]} alt="" width="100%"/>
                             <span id="sp1">
                                 </span>
                             <span id="sp2">{this.state.arrWords[4]}</span>
                         </a>
                     </li>
                 </ul>
